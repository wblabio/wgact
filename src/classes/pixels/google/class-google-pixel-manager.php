...
//                wp_enqueue_script('wooptpm-google-premium-only', plugin_dir_url(__DIR__) . '../../js/public/google__premium_only.js', ['jquery', 'wooptpm', 'wooptpm-premium-only'], WGACT_CURRENT_VERSION, false);
                wp_enqueue_script('wooptpm-google-premium-only', WOOPTPM_PLUGIN_DIR_PATH . 'js/public/google__premium_only.js', ['jquery', 'wooptpm', 'wooptpm-premium-only'], WGACT_CURRENT_VERSION, false);
...
//                wp_enqueue_script('wooptpm-ga-ua-eec', plugin_dir_url(__DIR__) . '../../js/public/google-ga-ua-eec__premium_only.js', ['jquery', 'wooptpm', 'wooptpm-premium-only'], WGACT_CURRENT_VERSION, true);
                wp_enqueue_script('wooptpm-ga-ua-eec', WOOPTPM_PLUGIN_DIR_PATH . 'js/public/google-ga-ua-eec__premium_only.js', ['jquery', 'wooptpm', 'wooptpm-premium-only'], WGACT_CURRENT_VERSION, true);
...
//                wp_enqueue_script('wooptpm-ga4-eec', plugin_dir_url(__DIR__) . '../../js/public/google-ga-4-eec__premium_only.js', ['jquery', 'wooptpm', 'wooptpm-premium-only'], WGACT_CURRENT_VERSION, true);
                wp_enqueue_script('wooptpm-ga4-eec', WOOPTPM_PLUGIN_DIR_PATH . 'js/public/google-ga-4-eec__premium_only.js', ['jquery', 'wooptpm', 'wooptpm-premium-only'], WGACT_CURRENT_VERSION, true);
