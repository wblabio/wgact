...
class Pinterest_Pixel_Manager extends Pixel_Manager_Base
{
    ...
    {
        $this->pinterest_pixel->inject_product($product_id, $product, $product_attributes);
    }
    ...
    {
        $this->pinterest_pixel->inject_order_received_page($order, $order_total, $order_item_ids, $is_new_customer);
    }
