...
//		$this->add_section_main_subsection_facebook($section_ids);
	...
	public function wgact_plugin_options_page() {
		?>
            <div id="script-blocker-notice" class="notice notice-error" style="width:90%; float: left; margin: 5px; font-weight: bold">
                <p>
        ...
        <div style="width:90%; float: left; margin: 5px">
                ...
                <div class="developer-banner">
                    <div>
                        ...
                        <a href="https://wolfundbaer.ch/<?php echo $this->get_link_locale() ?>/?utm_source=plugin&utm_medium=banner&utm_campaign=wgact_plugin" target="_blank">https://wolfundbaer.ch
						</a>
					</span>
                    </div>
                </div>
		...
		?>
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div>
                    ...
                    <a href="https://wolfundbaer.ch/<?php echo $this->get_link_locale() ?>/?utm_source=plugin&utm_medium=banner&utm_campaign=wgact_plugin" target="_blank">https://wolfundbaer.ch</a>
...
//        $html .= 'Script blocker detected:';
    ...
    public function wgact_plugin_option_dynamic_remarketing() {
        ...
        // https://stackoverflow.com/a/1992745/4688612
        ?>
                <input type='hidden' value='0' name='wgact_plugin_options[gads][dynamic_remarketing]'>
                <input type='checkbox' id='wgact_plugin_option_gads_dynamic_remarketing' name='wgact_plugin_options[gads][dynamic_remarketing]'
                       value='1' <?php checked( $this->options['gads']['dynamic_remarketing'] ); ?> />
...
//		error_log(print_r($input, true));
    ...
    protected function non_form_keys(): array
    {
        return [
            ...
            'gads' => [
                'google_business_vertical' => $this->options['gads']['google_business_vertical'],
            ]
        ];
    }
