...
//		add_action( 'wp_enqueue_scripts', [$this,'wgact_admin_scripts'] );
	...
	public function wgact_admin_scripts($hook)
    {
	    ...
	    wp_enqueue_script( 'admin-helpers', plugin_dir_url( __DIR__ ) . 'js/admin-helpers.js', array(), '1.0', true );
	    wp_enqueue_script( 'admin-tabs', plugin_dir_url( __DIR__ ) . 'js/admin-tabs.js', array(), '1.0', true );
    }
	...
	public function wgact_plugin_admin_init() {
		...
		$this->add_beta_section();
		$this->add_support_section();
		$this->add_author_section();
	}

	public function add_main_section() {
		add_settings_section(
			'wgact_plugin_options_main_section',
			esc_html__( 'Main', $this->text_domain ),
	...
	public function add_advanced_section() {

		add_settings_section(
			'wgact_plugin_advanced_section',
			esc_html__(
				'Advanced',
				$this->text_domain
			),
	...
	public function add_beta_section() {
	...
	public function add_support_section() {
		add_settings_section(
			'wgact_plugin_support_section',
			esc_html__( 'Support', $this->text_domain ),
			[ $this, 'wgact_plugin_section_support_description' ],
			'wgact_plugin_options_page'
		);
	}

	public function add_author_section(){
		add_settings_section(
			'wgact_plugin_author_section',
			esc_html__( 'Author', $this->text_domain ),
...
<!--                       class="nav-tab --><?php //echo $active_tab == 'main_options' ? 'nav-tab-active' : ''; ?><!--">Main</a>-->
<!--                    <a href="?page=wgact&tab=advanced_options"-->
<!--                       class="nav-tab --><?php //echo $active_tab == 'advanced_options' ? 'nav-tab-active' : ''; ?><!--">Advanced</a>-->
<!--                    <a href="?page=wgact&tab=beta_options"-->
<!--                       class="nav-tab --><?php //echo $active_tab == 'beta_options' ? 'nav-tab-active' : ''; ?><!--">Beta</a>-->
...
<!--                </h2>-->
	...
	public function wgact_plugin_section_author_description() {
		?>
        <div style="margin-bottom: 30px">
			<?php _e( 'More details about the developer of this plugin: ', $this->text_domain ); ?>
        </div>
        <div style="margin-bottom: 30px;">
            <div>Developer: Wolf+Bär Agency</div>
            <div>Website: <a href="https://wolfundbaer.ch" target="_blank">https://wolfundbaer.ch</a></div>
